...
"""
print(f"{year} {name} for about ${cost:,.0f}!")  # Prints an f-string which replicates the output above
...
2 ^10 is 1024
"""
for power in range(11):  # For loop with a range of 11
    print(f"2 ^{power:2} is {2 ** power:4}")  # Prints an f-string which replicates the output above
