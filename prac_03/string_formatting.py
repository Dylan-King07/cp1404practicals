...
print(f"{year} {name} for about ${cost:,.0f}!")  # Print the sentence above using f-string formatting
...
for power in range(11):
    print(f"2 ^{power:2} is {2 ** power:4}")  # Used a for loop and range from 0 to 10 to produce the above output
